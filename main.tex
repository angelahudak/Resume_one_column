...
\smallskip
    \begin{tightlist}
    \item Authored and maintained AWS Braket Developer Guide and API Reference documentation using {\bf{XML}} and {\bf{Git}}
...
\smallskip
    \begin{tightlist}
    \item  Designed, prototyped, and tested {\bf{PCBs}} using {\bf{KiCAD}} and validated designs with {\bf{LTSPICE}}
    \item Performed {\bf{through-hole soldering (THT)}} for board assembly and rework
    \item Used {\bf{breadboards}} for hardware prototyping, concept validation, and debugging electrical systems
...
\smallskip
    \begin{tightlist}
    \item Built a backend application to store and analyze data using {\bf{Python}} and the {\bf{Pandas API}}  library
